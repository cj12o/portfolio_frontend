  ...
  const projects = [
    {
      ...
      href: "#",
      description:
        "lorem dbhjf fsefgwufygb fbfifawrkwjw oifjoifweifewof fiufhweiufhweuf fwrefhfurefhi9f h8jfwuwewnn",
    },
    {
      title: "prj2",
      src: "/neymar.jpg",
        ...
        {projects.map((prj, idx) => {
          return (
            ...
            >
              ...
              />
              <h2 className="font-medium tracking-tight text-neutral-500 mt-2">
                {prj.title}
              </h2>
